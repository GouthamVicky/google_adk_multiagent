...
➡️ [View Sample Tokyo Itinerary](sample_outputs/Tokyo_Adventure_Your_Travel_Guide.pdf)

➡️ [View Sample Paris Itinerary](sample_outputs/weekend_in_paris.png)

## Sample Convo to Test the agent
...
```bash
Plan a trip to Japan on this year august month. Pick any flights and any seats; also Any hotels and room type. Make sure you pick seats for both flights. Go ahead and act on my behalf without my input, until you have selected everything, confirm with me before generating an itinerary.
```
...
Reference - [Model Context Protocol](https://www.anthropic.com/news/model-context-protocol?utm_source=chatgpt.com)
​
...
Reference - [Agents to agents communnication](https://developers.googleblog.com/en/a2a-a-new-era-of-agent-interoperability/?utm_source=chatgpt.com)
